...
class GeographicRasterMetadataInRDF(BaseAggregationMetadataInRDF):
    rdf_type: AnyUrl = Field(rdf_predicate=RDF.type, frozen=True, default=HSTERMS.GeographicRasterAggregation)
    ...
    dc_type: AnyUrl = Field(rdf_predicate=DC.type, default=HSTERMS.GeographicRasterAggregation, frozen=True)
...
class GeographicFeatureMetadataInRDF(BaseAggregationMetadataInRDF):
    ...
    dc_type: AnyUrl = Field(rdf_predicate=DC.type, default=HSTERMS.GeographicFeatureAggregation, frozen=True)
...
class MultidimensionalMetadataInRDF(BaseAggregationMetadataInRDF):
    ...
    dc_type: AnyUrl = Field(rdf_predicate=DC.type, default=HSTERMS.MultidimensionalAggregation, frozen=True)
...
class TimeSeriesMetadataInRDF(BaseAggregationMetadataInRDF):
    ...
    dc_type: AnyUrl = Field(rdf_predicate=DC.type, default=HSTERMS.TimeSeriesAggregation, frozen=True)
...
class SingleFileMetadataInRDF(BaseAggregationMetadataInRDF):
    rdf_type: AnyUrl = Field(rdf_predicate=RDF.type, frozen=True, default=HSTERMS.SingleFileAggregation)
...
class ModelProgramMetadataInRDF(BaseAggregationMetadataInRDF):
    rdf_type: AnyUrl = Field(rdf_predicate=RDF.type, frozen=True, default=HSTERMS.ModelProgramAggregation)
    ...
    dc_type: AnyUrl = Field(rdf_predicate=DC.type, default=HSTERMS.ModelProgramAggregation, frozen=True)
    ...
    release_notes: List[AnyUrl] = Field(rdf_predicate=HSTERMS.modelReleaseNotes, default=[])
    documentation: List[AnyUrl] = Field(rdf_predicate=HSTERMS.modelDocumentation, default=[])
    software: List[AnyUrl] = Field(rdf_predicate=HSTERMS.modelSoftware, default=[])
    engine: List[AnyUrl] = Field(rdf_predicate=HSTERMS.modelEngine, default=[])
...
class ModelInstanceMetadataInRDF(BaseAggregationMetadataInRDF):
    ...
    dc_type: AnyUrl = Field(rdf_predicate=DC.type, default=HSTERMS.ModelInstanceAggregation, frozen=True)
